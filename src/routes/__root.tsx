...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mortuary transport dispatch and chain-of-custody tracking." },
      { name: "author", content: "Transport Dispatch" },
      { property: "og:title", content: "Transport Dispatch" },
      { property: "og:description", content: "Mortuary transport dispatch and chain-of-custody tracking." },
